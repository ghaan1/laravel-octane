    ...
    <div class="modal-dialog modal-dialog-centered mw-750px">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="fw-bold">Ubah Role</h2>
                <div class="btn btn-icon btn-sm btn-active-icon-primary" id="close_modal_edit_button">
                    <i class="ki-duotone ki-cross fs-1"><span class="path1"></span><span class="path2"></span></i>
                </div>
            </div>
            <div class="modal-body scroll-y mx-lg-5 my-7">
                <form id="kt_modal_edit_role_form" class="form" method="POST" action="">
                    @csrf
                    @method('PUT')
                                                ...
                                                <td>
                                                    <label class="form-check form-check-custom form-check-solid">
                                                        <input class="form-check-input group-checkbox" type="checkbox"
                                                            ...
                                                            name="permissions[]" class="permission-checkbox">
                                                    </label>
                                                </td>
                                            </tr>
                    ...
                    <div class="text-center pt-15">
                        <button type="reset" class="btn btn-light me-3" id="cancel_edit_button">Batal</button>
